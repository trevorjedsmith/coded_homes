...
namespace CodedHomes.Admin
{
    public class Global : System.Web.HttpApplication
    {
        ...
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            {
                return ((IObjectContextAdapter)new CodedHomesDbEntities()).ObjectContext;
            }, new ContextConfiguration() { ScaffoldAllTables = true });

            // The following registration should be used if YourDataContextType does not derive from DbContext
            //DefaultModel.RegisterContext(typeof(CodedHomesDbEntities), new ContextConfiguration() { ScaffoldAllTables = true });
